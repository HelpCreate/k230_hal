...
pub type rt_err_t = ::std::os::raw::c_int;
pub type rt_base_t = ::std::os::raw::c_int;
pub type rt_uint32_t = ::std::os::raw::c_uint;
pub type rt_int32_t = ::std::os::raw::c_int;
...
pub type _gpio_pin_edge = ::std::os::raw::c_uint;
...
pub type _gpio_drive_mode = ::std::os::raw::c_uint;
...
pub type _gpio_pin_value = ::std::os::raw::c_uint;
pub use self::_gpio_pin_value as gpio_pin_value_t;
extern "C" {
    pub fn rt_hw_pin_init() -> ::std::os::raw::c_int;
}
extern "C" {
...
extern "C" {
    pub fn kd_pin_attach_irq(
        pin: rt_int32_t,
        mode: rt_uint32_t,
        hdr: ::std::option::Option<unsafe extern "C" fn(args: *mut ::std::os::raw::c_void)>,
...
extern "C" {
    pub fn kd_pin_read(pin: rt_base_t) -> ::std::os::raw::c_int;
}
